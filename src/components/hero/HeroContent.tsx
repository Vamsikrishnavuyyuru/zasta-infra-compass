...
const HeroContent = ({ slides, currentSlide, onWorkWithUs }: HeroContentProps) => {
  return (
    <div className="max-w-5xl mx-auto animate-fade-in px-3 sm:px-4 lg:px-6">
      ...
      <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl mb-8 sm:mb-10 md:mb-12 text-white animate-fade-in leading-[1.5] max-w-4xl mx-auto font-medium hero-subtitle" style={{ animationDelay: '0.2s' }}>
