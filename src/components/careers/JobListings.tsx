...
const JobListings = ({ onApply }: JobListingsProps) => {
  ...
  const currentOpenings: JobOpening[] = [
    ...
    },
    {
      ...
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of experience in high-rise MEP coordination.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for site-level mechanical inspections at the Vizag ETP project. You will perform routine quality checks on piping, valves, and mechanical assemblies to ensure they align with the project's technical specifications.",
      requirements: [
        "Bachelor’s degree in Mechanical Engineering.",
        "4 years of experience in mechanical site inspection.",
        "Previous experience in Effluent Treatment Plants (ETP) or Industrial projects is mandatory.",
        "Ability to read GA drawings and monitor installation quality on-site.",
        "Strong focus on technical documentation and inspection logs.",
      ],
      postedDate: "2026-02-19",
    },
    {
      ...
      vacancy: 1,
      description:
        "The Safety Engineer will manage industrial safety protocols for the ETP construction site. You will focus on chemical hazard mitigation, confined space entry, and ensuring a zero-incident environment during the installation and testing phases.",
      requirements: [
        "Degree/Diploma in Engineering with ADIS or NEBOSH certification.",
        "5+ years of experience in industrial safety management.",
        "Mandatory experience in Effluent Treatment Plants (ETP) or Industrial plant environments.",
        "Expertise in HIRA (Hazard Identification and Risk Assessment) for industrial sites.",
        "Ability to conduct specialized safety training for labor and technical staff.",
      ],
      postedDate: "2026-02-19",
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking an MEP Engineer to lead the service installations for a premium villa project. You will manage the integration of high-end mechanical, electrical, and plumbing systems, ensuring they meet the custom architectural requirements of independent residential units.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5 to 8 years of experience in MEP site execution.",
        "Mandatory proven experience in luxury Villa projects.",
    ...
    },
    {
      ...
      requirements: [
        "Degree/Diploma in Engineering with ADIS or NEBOSH certification.",
        "4 years of experience in industrial safety management.",
        "Mandatory experience in Effluent Treatment Plants (ETP) or Industrial plant environments.",
        "Expertise in HIRA (Hazard Identification and Risk Assessment) for industrial sites.",
        "Ability to conduct specialized safety training for labor and technical staff.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for conducting mechanical inspections for an Effluent Treatment Plant (ETP). You will verify the installation quality of industrial pumps, piping, and filtration units against technical drawings.",
      requirements: [
        "Bachelor’s degree in Mechanical Engineering.",
        "4 years of experience in industrial mechanical inspection.",
        "Mandatory experience in ETP or large-scale Industrial plants.",
        "Ability to read P&IDs and GA drawings.",
        "Detail-oriented reporting on site quality compliance.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead the mechanical QA/QC efforts for a major industrial ETP project. You will oversee equipment testing, material verification, and final commissioning of mechanical systems.",
      requirements: [
        "Bachelor’s degree in Mechanical Engineering.",
        "7 years of experience in mechanical inspection/QA/QC.",
        "Mandatory experience in Effluent Treatment Plant (ETP) or Industrial sectors.",
        "Expertise in NDT, pressure testing, and vendor document review.",
        "Proven leadership in managing site-level quality audits.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      location: "Sankarpalli, Hyderabad, India",
      type: "Full-time",
      experience: "10-12 years",
      vacancy: 1,
      description:
        "The Quality Lead will drive the QA/QC strategy for a high-rise residential project. You will ensure that Mivan formwork cycles and concrete quality meet structural and aesthetic benchmarks.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10-12 years of experience in construction quality management.",
        "Mandatory experience in High-Rise projects utilizing Mivan technology.",
        "Strong knowledge of concrete technology and finish quality standards.",
        "Ability to implement and monitor Project Quality Plans (PQP).",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking a Project Lead to manage end-to-end execution of residential developments. You will be responsible for site progress, resource management, and stakeholder communication.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10-12 years of experience in residential construction.",
        "Strong track record in delivering apartments or luxury villa projects on time.",
        "Excellent team management and technical problem-solving skills.",
        "Familiarity with project planning tools and cost control.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead the quality department for high-rise developments in Delhi. You will enforce strict quality control protocols during the structural and finishing phases of Mivan-based construction.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10-12 years of experience in building QA/QC.",
        "Mandatory experience in High-Rise projects using Mivan technology.",
        "Expertise in snagging, de-snagging, and handover documentation.",
        "Knowledge of local building codes and IS standards.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for quantity take-offs, BOQ preparation, and contractor billing. You will monitor project costs and verify work-done measurements for residential sites.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "4-6 years of experience in QS and Billing.",
        "Mandatory residential construction experience.",
        "Proficiency in MS Excel and billing software.",
        "Strong analytical skills for material reconciliation.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "Coordinate and execute MEP services for residential projects. You will ensure electrical, plumbing, and HVAC systems are installed as per residential design standards.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4-6 years of residential MEP site experience.",
        "Ability to coordinate with civil teams for sleeve and conduit planning.",
        "Knowledge of firefighting systems and domestic utilities.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage MEP installations at our Tellapur residential site. Focus on ensuring quality and safety in electrical distribution and internal plumbing for residential units.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4-6 years of experience in residential projects.",
        "Strong site supervision and sub-contractor management skills.",
        "Familiarity with local utility standards.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "MEP Engineer for a High-Rise project in Miyapur. You will manage service integration within the Mivan structural cycle and ensure timely delivery of MEP vertical services.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4-6 years of experience in High-Rise construction.",
        "Mandatory experience in Mivan technology projects.",
        "Strong technical skills in reading complex vertical service layouts.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee MEP execution for a high-rise tower. You will focus on service coordination, fire safety systems, and MEP infrastructure specific to Mivan buildings.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of MEP experience in High-Rise buildings.",
        "Mandatory experience with Mivan formwork service integration.",
        "Expertise in coordinating with MEP consultants and site teams.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage high-end finishing works (tiling, painting, joinery) for a high-rise development. Ensure luxury quality benchmarks are met post-Mivan structural phase.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "5+ years of finishing experience in High-Rise projects.",
        "Mandatory Mivan technology project experience.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee structural site execution for a Mivan-based high-rise. You will ensure the structural integrity, reinforcement quality, and precise casting of Mivan wall/slab systems.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "5+ years of experience in High-Rise structural execution.",
        "Mandatory experience in Mivan/Aluminum formwork technology.",
        "Strong skills in drawing interpretation and BBS verification.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      vacancy: 1,
      description:
        "The Precast QA/QC Engineer will manage quality audits for the RMC plant and precast element production. You will ensure concrete strength, dimensional accuracy, and finish quality of precast units.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "7 years of experience in QA/QC for RMC/Precast plants.",
        "In-depth knowledge of concrete mix designs and casting quality.",
        "Expertise in inspecting precast elements and testing procedures.",
        "Familiarity with RMC batching plant operations.",
      ],
      postedDate: "2026-02-27",
    },
    {
      ...
      requirements: [
        ...
        "4 years of experience in industrial mechanical inspection.",
        "Mandatory experience in ETP or large-scale Industrial plants.",
        "Ability to read P&IDs (Piping and Instrumentation Diagrams) and GA drawings.",
        "Detail-oriented reporting on site quality compliance.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Drive the QA/QC strategy for a high-rise residential project. You will ensure that Mivan formwork cycles and concrete quality meet structural and aesthetic benchmarks.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10-12 years of experience in construction quality management.",
        "Mandatory experience in High-Rise projects utilizing Mivan technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Seeking a Project Lead to manage end-to-end execution of residential developments. Responsible for site progress, resource management, and stakeholder communication.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10-12 years of experience in residential construction.",
        "Strong track record in delivering apartments or luxury villa projects on time.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead the quality department for high-rise developments in Delhi. Enforce strict quality control protocols during Mivan-based construction structural and finishing phases.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10-12 years of experience in building QA/QC.",
        "Mandatory experience in High-Rise projects using Mivan technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for quantity take-offs, BOQ preparation, and contractor billing for residential sites. Monitor project costs and verify work-done measurements.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "4-6 years of experience in QS and Billing.",
        "Mandatory residential construction experience.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Coordinate and execute MEP services for residential projects. Ensure electrical, plumbing, and HVAC systems are installed as per residential design standards.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4-6 years of residential MEP site experience.",
        "Ability to coordinate with civil teams for sleeve and conduit planning.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage MEP installations at the Tellapur residential site. Focus on quality and safety in electrical distribution and internal plumbing for residential units.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4-6 years of experience in residential projects.",
        "Strong site supervision and sub-contractor management skills.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "MEP Engineer for a High-Rise project in Miyapur. Manage service integration within the Mivan structural cycle and ensure timely delivery of MEP vertical services.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4-6 years of experience in High-Rise construction.",
        "Mandatory experience in Mivan technology projects.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee MEP execution for a high-rise tower. Focus on service coordination, fire safety systems, and MEP infrastructure specific to Mivan buildings.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of MEP experience in High-Rise buildings.",
        "Mandatory experience with Mivan formwork service integration.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage high-end finishing works (tiling, painting, joinery) for a high-rise development. Ensure luxury quality benchmarks post-Mivan structural phase.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "5+ years of finishing experience in High-Rise projects.",
        "Mandatory Mivan technology project experience.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee structural site execution for a Mivan-based high-rise. Ensure structural integrity, reinforcement quality, and precise casting of Mivan systems.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "5+ years of experience in High-Rise structural execution.",
        "Mandatory experience in Mivan/Aluminum formwork technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage quality audits for the RMC plant and precast element production. Ensure concrete strength, dimensional accuracy, and finish quality of precast units.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "7 years of experience in QA/QC for RMC/Precast plants.",
        "In-depth knowledge of concrete mix designs and casting quality.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for site-level mechanical inspections at our industrial ETP project. You will verify that mechanical installations align with technical drawings and meet the operational standards required for industrial waste treatment.",
      requirements: [
        "Bachelor’s degree in Mechanical Engineering.",
        "4 years of experience in mechanical site inspection.",
        "Mandatory experience in Effluent Treatment Plants (ETP) or Industrial projects.",
        "Ability to read mechanical GA drawings and P&ID diagrams.",
        "Strong focus on documentation and inspection logging.",
      ],
    ...
    },
    {
      ...
      requirements: [
        ...
        "Mandatory experience in Effluent Treatment Plants (ETP) or large Industrial plants.",
        "Expertise in inspecting heavy-duty pumps, blowers, and specialized filtration systems.",
        "Knowledge of industrial testing protocols and compliance standards.",
      ],
      postedDate: "2026-03-12",
    },
    {
      ...
      requirements: [
        ...
        "10-12 years of experience in construction quality management.",
        "Mandatory experience in High-Rise projects utilizing Mivan technology.",
        "Expertise in implementing Project Quality Plans (PQP) and handling audits.",
        "Strong leadership skills to manage a team of quality engineers.",
      ],
      postedDate: "2026-03-12",
    },
    {
      ...
      vacancy: 1,
      description:
        "Seeking a Project Lead to manage end-to-end execution of residential developments. You will be responsible for site progress, resource management, and stakeholder communication.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10-12 years of experience in residential construction.",
        "Proven track record in delivering apartments or luxury villa projects.",
        "Strong team management and technical problem-solving skills.",
        "Familiarity with project planning tools and budget control.",
      ],
      postedDate: "2026-03-12",
    },
    {
      ...
      requirements: [
        ...
        "Mandatory experience in High-Rise projects using Mivan technology.",
        "Expertise in snagging, de-snagging, and handover documentation.",
        "In-depth knowledge of local building codes and IS standards.",
      ],
      postedDate: "2026-03-12",
    },
    {
      ...
      requirements: [
        ...
        "4-6 years of experience in QS and Billing.",
        "Mandatory experience in residential construction projects.",
        "Proficiency in MS Excel and specialized billing software.",
        "Strong analytical skills for material reconciliation and cost tracking.",
      ],
      postedDate: "2026-03-12",
    },
    {
    ...
    },
    {
      ...
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4-6 years of core experience in residential projects.",
        "Strong site supervision and sub-contractor management skills.",
        "Familiarity with local utility standards and luxury finishes.",
      ],
      postedDate: "2026-03-12",
    },
    {
    ...
    },
    {
      ...
      requirements: [
        ...
        "5+ years of MEP experience in High-Rise buildings.",
        "Mandatory experience with Mivan formwork service integration.",
        "Expertise in coordinating with consultants and site execution teams.",
      ],
      postedDate: "2026-03-12",
    },
    {
      ...
      requirements: [
        ...
        "5+ years of finishing experience in High-Rise projects.",
        "Mandatory experience in projects utilizing Mivan technology.",
        "Strong attention to detail and commitment to luxury aesthetic finishes.",
      ],
      postedDate: "2026-03-12",
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee structural site execution for a Mivan-based high-rise. You will ensure structural integrity, reinforcement quality, and precise casting of Mivan systems.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "5+ years of experience in High-Rise structural execution.",
        "Mandatory experience in Mivan/Aluminum formwork technology.",
        "Ability to interpret structural drawings and manage reinforcement/concreting schedules.",
      ],
      postedDate: "2026-03-12",
    },
    {
      id: 119,
      title: "Precast QA/QC Engineer",
      department: "Quality Control",
      location: "Kokapeta, Hyderabad, India",
      type: "Full-time",
      experience: "7 years",
      ...
      requirements: [
        ...
        "7 years of experience in QA/QC for RMC/Precast plants.",
        "In-depth knowledge of concrete mix designs and casting quality.",
        "Expertise in inspecting precast elements and conducting lab testing procedures.",
      ],
      postedDate: "2026-03-12",
    },
    {
      ...
      department: "Civil Engineering",
      location: "Hyderabad / Site Offices",
      type: "Internship",
      experience: "Fresh Graduate / Final Year",
      vacancy: 1,
      description:
        "Join our Internship Program 2026 to learn, grow, and build your career in project planning. Preferred for women candidates looking to enter office-based management roles in construction.",
      requirements: [
        "Final year student or fresh graduate in Civil Engineering.",
        "Passionate and eager to learn project scheduling and planning tools.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Learn the fundamentals of quantity surveying, BOQ preparation, and billing processes under the mentorship of industry professionals.",
      requirements: [
        "Relevant degree in Civil Engineering (Final year or Fresh Graduate).",
        "Interest in cost estimation and material reconciliation.",
        "Basic proficiency in MS Excel.",
        "Preferred for women candidates.",
      ],
      postedDate: "2026-03-13",
    },
    {
      id: 122,
      title: "Contracts Intern",
      department: "Civil Engineering",
      location: "Hyderabad / Site Offices",
      type: "Internship",
      experience: "Fresh Graduate / Final Year",
      vacancy: 1,
      description:
        "Gain hands-on experience in contract management, documentation, and industrial compliance within the construction sector.",
      requirements: [
        "Relevant degree in Civil Engineering or Management.",
        "Keen interest in legal documentation and contract administration.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Build your career on-site with hands-on experience in civil construction. Preferred for men candidates looking for rigorous field training and site execution.",
      requirements: [
        "B.Tech/B.E. in Civil Engineering (Final year or Fresh Graduate).",
        "Willingness to work on-site and learn execution workflows.",
        "Strong physical stamina and team-playing spirit.",
        "Eager to develop technical site-management skills.",
      ],
      postedDate: "2026-03-13",
    },
    {
      ...
      department: "Civil Engineering",
      location: "Project Sites / Industrial Plants",
      type: "Internship",
      experience: "Fresh Graduate / Final Year",
      vacancy: 1,
      description:
        "Gain exposure to mechanical installations, HVAC, and industrial plant maintenance (ETP/Industrial) under professional mentorship.",
      requirements: [
        "B.Tech/B.E. in Mechanical Engineering.",
        "Passionate about industrial machinery and mechanical systems.",
        "Eager to learn site-level troubleshooting.",
        "Preferred for men candidates.",
      ],
      postedDate: "2026-03-13",
    },
    {
      ...
      vacancy: 1,
      description:
        "Learn the essentials of construction quality control, material testing, and compliance standards on high-rise or industrial projects.",
      requirements: [
        "Relevant degree in Engineering (Civil/Mechanical/Electrical).",
        "Interest in QA/QC protocols and laboratory testing.",
        "Commitment to maintaining high engineering standards.",
        "Ability to document and report technical findings.",
      ],
      postedDate: "2026-03-13",
    },
    {
      ...
      vacancy: 1,
      description:
        "Senior-level mechanical inspection role focused on the QA/QC of systems within an Effluent Treatment Plant (ETP). You will lead the verification of industrial equipment, piping, and mechanical filtration units to ensure industrial compliance.",
      requirements: [
        "Bachelor’s degree in Mechanical Engineering.",
        "7 years of core experience in mechanical inspection and industrial QA/QC.",
        "Mandatory experience in Effluent Treatment Plants (ETP) or large Industrial plants.",
        "Expertise in inspecting heavy-duty pumps, blowers, and specialized filtration systems.",
        "Advanced knowledge of industrial testing protocols (NDT/Pressure testing) and compliance standards.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for quantity take-offs, BOQ preparation, and contractor billing. You will monitor project costs and verify work-done measurements for residential site developments.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "4 to 6 years of experience in QS and Billing roles.",
        "Mandatory experience in residential construction projects.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Coordinate and execute MEP services for residential projects. You will ensure electrical, plumbing, and HVAC systems are installed as per residential design standards and independent unit specifications.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4 to 6 years of residential MEP site experience.",
        "Ability to coordinate with civil teams for sleeve and conduit planning in residential units.",
        "Knowledge of firefighting systems and domestic utilities (STP/WTP coordination).",
      ],
      postedDate: "2026-03-16",
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage MEP installations at our Tellapur residential site. Focus on ensuring quality and safety in electrical distribution and internal plumbing for premium residential units.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4 to 6 years of core experience in residential projects.",
        "Strong site supervision and sub-contractor management skills.",
        "Familiarity with local utility standards and luxury apartment/villa finishes.",
      ],
      postedDate: "2026-03-16",
    },
    {
      ...
      vacancy: 1,
      description:
        "MEP Engineer for a High-Rise project in Miyapur. You will manage service integration within the Mivan structural cycle and ensure timely delivery of vertical MEP services.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4 to 6 years of experience in High-Rise construction.",
        "Mandatory experience in projects utilizing Mivan technology.",
        "Strong technical skills in reading complex vertical service layouts and planning sleeves.",
      ],
      postedDate: "2026-03-16",
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee MEP execution for a high-rise tower. Focus on service coordination, fire safety systems, and MEP infrastructure specific to Mivan (Aluminum) formwork buildings.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of MEP experience in High-Rise buildings.",
        "Mandatory experience with Mivan formwork service integration.",
        "Expertise in coordinating with MEP consultants and ensuring site execution matches shop drawings.",
      ],
      postedDate: "2026-03-16",
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee structural site execution for a Mivan-based high-rise development. You will ensure structural integrity, reinforcement quality, and the precise casting of Mivan wall and slab systems.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil/Structural Engineering.",
        "5+ years of experience in High-Rise structural execution.",
        "Mandatory experience in Mivan/Aluminum formwork technology.",
        "Advanced skills in reinforcement verification, BBS checking, and concrete quality control for rapid-cycle casting.",
      ],
      postedDate: "2026-03-16",
    },
    {
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Senior-level mechanical inspection role for an Effluent Treatment Plant (ETP). You will lead the QA/QC of industrial infrastructure, ensuring heavy-duty mechanical systems meet industrial plant standards.",
      requirements: [
        "Bachelor’s degree in Mechanical Engineering.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for managing quantity take-offs and contractor billing for residential developments. This role involves precise cost monitoring and material reconciliation.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "4 to 6 years of experience in QS and Billing roles.",
        "Mandatory experience in residential construction projects.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Coordinate MEP services for residential projects. Focus on the seamless integration of electrical, plumbing, and HVAC systems within residential unit specifications.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4 to 6 years of residential MEP site experience.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee MEP installations at the Tellapur residential site. Ensure high-quality execution of internal services and infrastructure for premium residential units.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead MEP coordination for a Mivan-based high-rise in Miyapur. Ensure service integration aligns with the aluminum formwork construction cycles.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4 to 6 years of experience in High-Rise construction.",
        "Mandatory experience in projects utilizing Mivan technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee MEP execution for a Mivan high-rise tower. Focus on technical coordination of services, fire safety infrastructure, and high-density MEP distribution.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of MEP experience in High-Rise buildings.",
        "Mandatory experience with Mivan formwork service integration.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage structural site execution for a Mivan high-rise development. Ensure reinforcement precision and structural integrity during rapid casting cycles.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "5+ years of experience in High-Rise structural execution.",
        "Mandatory experience in Mivan/Aluminum formwork technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead the QA/QC department for a high-rise project in Noida. We require a veteran manager capable of overseeing Mivan-based construction and finishing quality. Immediate joiner required.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "12+ years of experience in construction quality management.",
        "Mandatory experience in High-Rise projects using Mivan technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for quality standards at a residential site in Gurugram. Monitor material testing and site execution to ensure zero-defect construction. Immediate joiner required.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking a Finishing Engineer to manage high-end internal and external finishing works for a high-rise residential project. You will be responsible for the transition from Mivan structural completion to final handover, ensuring zero-defect delivery of tiling, painting, and joinery.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "5 to 8 years of experience in finishing works.",
        "Mandatory experience in High-Rise buildings utilizing Mivan technology.",
        "In-depth knowledge of surface preparation, waterproofing, and finishing sequences following Mivan de-shuttering.",
        "Strong attention to detail and ability to manage multiple sub-contractors for quality finishes.",
        "Expertise in snagging, de-snagging, and final unit handover protocols.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Critical leadership role for a high-rise residential project. We require a veteran Quality Manager to lead the QA/QC department, specifically focusing on Mivan technology standards. This position requires an immediate joiner.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "12+ years of core experience in construction quality management.",
        "Mandatory expertise in High-Rise projects utilizing Mivan technology.",
        "Proven ability to implement QMS and manage large-scale site audits.",
        "Immediate availability to join is required.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for maintaining zero-defect standards at our Gurugram residential site. You will monitor site execution, material testing, and finishing quality. Immediate joiner required.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "7+ years of experience in QA/QC for residential projects.",
        "Expertise in IS codes, documentation (NCR/Pour Cards), and material lab testing.",
        "Must be available to join immediately.",
        "Strong technical eye for finishing and structural quality.",
      ],
      postedDate: "2026-04-01",
    },
    {
      ...
      vacancy: 1,
      description:
        "Coordinate and execute MEP services for residential site developments. Focus on high-quality integration of electrical, plumbing, and fire safety systems.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4 to 6 years of experience in residential MEP execution.",
        "Proficiency in coordinating service layouts with civil structural teams.",
        "Knowledge of residential utility infrastructure (STP/WTP coordination).",
      ],
      postedDate: "2026-04-01",
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage MEP services for a high-rise tower project. This role focuses on service integration within Mivan construction cycles and ensuring vertical distribution efficiency.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of MEP experience in high-rise buildings.",
        "Mandatory experience in projects utilizing Mivan technology.",
        "Technical expertise in high-rise fire safety and vertical service integration.",
      ],
      postedDate: "2026-04-01",
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead the planning and scheduling for residential projects in Chevella. You will be responsible for the end-to-end project timeline, resource optimization, and monitoring Mivan cycle speeds.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10+ years of core experience in project planning.",
        "Mandatory experience in Residential projects using Mivan technology.",
        "Proficiency in MS Project or Primavera P6.",
        "Expertise in resource leveling, cost forecasting, and progress reporting.",
      ],
      postedDate: "2026-04-01",
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead the QA/QC department for a high-rise residential project in Noida. We require a veteran manager to oversee Mivan formwork quality and structural compliance. Immediate joiner required.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "12+ years of experience in construction quality management.",
        "Mandatory expertise in High-Rise projects utilizing Mivan technology.",
        "Ability to join immediately.",
        "Proven track record in implementing QMS and handling site audits.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for maintaining quality standards at our Gurugram residential site. Monitor material testing and site execution to ensure zero-defect construction. Immediate joiner required.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "7+ years of experience in QA/QC for residential projects.",
        "Must be available to join immediately.",
        "Expertise in IS codes, material testing, and technical documentation.",
      ],
      postedDate: "2026-04-09",
    },
    {
      ...
      vacancy: 1,
      description:
        "Coordinate and execute MEP services for residential developments. Focus on the seamless integration of electrical, plumbing, and fire safety systems.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "4 to 6 years of residential MEP site experience.",
        "Proficiency in coordinating service layouts with civil structural teams.",
        "Knowledge of residential utility infrastructure.",
      ],
      postedDate: "2026-04-09",
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage MEP services for a high-rise tower project. This role focuses on service integration within Mivan construction cycles and vertical distribution efficiency.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of MEP experience in high-rise buildings.",
        "Mandatory experience in projects utilizing Mivan technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Lead the planning and scheduling for residential projects in Chevella. Responsible for end-to-end project timelines and resource optimization.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10+ years of core experience in project planning.",
        "Mandatory experience in large-scale Residential projects.",
        "Proficiency in MS Project or Primavera P6.",
        "Strong skills in resource leveling and progress reporting.",
      ],
      postedDate: "2026-04-09",
    },
    {
      ...
      vacancy: 1,
      description:
        "Seeking a veteran Project Manager to lead luxury residential developments. You will manage the full project lifecycle, ensuring high-end standards are met within budget and timelines.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "18+ years of construction management experience.",
        "Mandatory proven experience in managing large-scale Residential projects.",
        "Expertise in stakeholder management and strategic resource planning.",
      ],
      postedDate: "2026-04-09",
    },
    {
      ...
      vacancy: 1,
      description:
        "Implement and maintain safety protocols on residential construction sites. Ensure a safe working environment for all staff through constant monitoring and training.",
      requirements: [
        "Degree/Diploma in Engineering with recognized Safety certification (ADIS/NEBOSH).",
        "5 years of safety experience in the construction sector.",
        "Mandatory track record in Residential project safety management.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Combined role managing Quantity Surveying and Project Planning for a high-rise project. Focus on cost control and scheduling within Mivan structural cycles.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "10 years of experience in QS and Planning.",
        "Mandatory experience in High-Rise projects using Mivan technology.",
        "Proficiency in Primavera P6/MS Project and billing software.",
        "Expertise in BOQ preparation and cost-to-complete analysis.",
      ],
      postedDate: "2026-04-09",
    },
    {
      ...
      vacancy: 1,
      description:
        "Coordinate and execute MEP services for residential projects. You will be responsible for the seamless integration of electrical, plumbing, and HVAC systems within residential unit specifications.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of core experience in residential MEP execution.",
        "Proficiency in coordinating service layouts with civil structural teams.",
        "Knowledge of residential utility infrastructure and local utility standards.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage MEP services for a high-rise tower project. This role focuses on service integration within Mivan construction cycles and vertical service distribution efficiency.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5+ years of MEP experience in high-rise buildings.",
        "Mandatory experience in projects utilizing Mivan technology.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Managerial role focused on project scheduling and strategic resource planning for residential developments. You will lead the planning department to ensure project milestones are achieved on time.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "10+ years of experience in project planning management.",
        "Mandatory track record in residential project delivery.",
        "Expertise in cost-to-complete analysis, critical path management, and progress reporting.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Oversee structural site execution for residential projects. Ensure reinforcement precision and structural integrity as per approved designs and safety standards.",
      requirements: [
        "Bachelor’s or Master’s degree in Structural/Civil Engineering.",
        "5 years of experience in structural site execution.",
        "Mandatory experience in Residential construction.",
        "Strong skills in reinforcement verification, BBS checking, and concrete quality control.",
      ],
      postedDate: "2026-04-17",
    },
    {
      ...
      vacancy: 1,
      description:
        "Veteran Project Manager to lead luxury residential developments. You will manage the full project lifecycle, ensuring high-end standards are met within budget and timelines.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "18+ years of construction management experience.",
        "Mandatory proven experience in managing large-scale Residential projects.",
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Manage high-end finishing works for a high-rise residential project in Tellapur. Ensure luxury quality benchmarks are met post-Mivan structural phase.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "6 years of finishing experience in residential projects.",
        "Mandatory experience in High-Rise projects utilizing Mivan technology.",
        "Strong attention to detail in tiling, painting, and joinery works.",
        "Ability to manage snags and final unit handovers.",
      ],
      postedDate: "2026-04-17",
    },
  ];
