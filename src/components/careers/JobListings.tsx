...
const JobListings = ({ onApply }: JobListingsProps) => {
  ...
  const currentOpenings: JobOpening[] = [
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "We are looking for a senior Project Manager to lead high-value residential developments. You will be responsible for overseeing the entire project lifecycle, from planning and resource allocation to final delivery, ensuring the highest standards of residential construction.",
      requirements: [
        "Bachelor’s or Master’s degree in Civil Engineering.",
        "18+ years of experience in the construction industry.",
        "Mandatory proven experience in managing large-scale residential projects (apartments/villas).",
        "Strong expertise in budget management, stakeholder coordination, and strategic project delivery.",
        "Excellent leadership skills with a track record of meeting tight deadlines.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "Responsible for the end-to-end execution of Mechanical, Electrical, and Plumbing services for residential projects. You will ensure that all MEP installations meet technical specifications and quality standards for residential living.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5 to 8 years of experience in MEP site supervision.",
        "Specific experience in residential construction projects is mandatory.",
        "Ability to coordinate complex HVAC, plumbing, and electrical layouts.",
        "Strong sub-contractor management and site coordination skills.",
      ],
      postedDate: "2026-01-29",
    },
    {
      ...
      vacancy: 1,
      description:
        "This role is for a high-rise residential project utilizing Mivan technology. You will be responsible for coordinating MEP services within the unique constraints and speed of Mivan (Aluminum) formwork systems.",
      requirements: [
        "Bachelor’s degree in Mechanical or Electrical Engineering.",
        "5 to 8 years of MEP experience in high-rise construction.",
        "Mandatory experience in projects using Mivan technology.",
        "Expertise in pre-casting sleeve placement and vertical service integration.",
        "Ability to work in a high-pressure, fast-paced construction environment.",
      ],
      postedDate: "2026-01-29",
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking a Finishing Engineer specialized in high-rise projects. You will manage internal and external finishes, ensuring high-quality aesthetics and workmanship following the Mivan structural phase.",
      requirements: [
        "Bachelor’s degree in Civil Engineering.",
        "5+ years of experience in finishing works (tiling, painting, joinery, etc.).",
        "Mandatory experience in high-rise buildings constructed with Mivan technology.",
        "Strong attention to detail and ability to deliver premium finishes under schedule pressure.",
        "Experience managing specialized finishing sub-contractors.",
      ],
      postedDate: "2026-01-29",
    },
    {
      ...
      vacancy: 1,
      description:
        "This role focuses on the inspection and quality assurance of mechanical components within an Effluent Treatment Plant (ETP). You will ensure that all industrial mechanical systems comply with technical drawings and environmental regulations.",
      requirements: [
        "Bachelor’s degree in Mechanical Engineering.",
        "7 years of experience in mechanical inspection and QA/QC.",
        "Mandatory experience in Effluent Treatment Plant (ETP) projects.",
        "Proficiency in inspecting industrial pumps, piping, and filtration systems.",
        "Knowledge of safety standards and mechanical testing protocols for industrial plants.",
      ],
      postedDate: "2026-01-29",
    },
  ];
