...
const JobListings = ({ onApply }: JobListingsProps) => {
  ...
  const currentOpenings: JobOpening[] = [
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking a skilled MEP Engineer with mandatory experience in high-rise Miven projects. The candidate will be responsible for the design, execution, and supervision of all Mechanical, Electrical, and Plumbing systems, ensuring seamless integration with the Miven construction method.",
      requirements: [
        "Bachelor's degree in Electrical or Mechanical Engineering is mandatory.",
        "Minimum 5 to 8 years of experience in MEP engineering.",
        "Mandatory proven experience in high-rise building projects using Miven technology.",
        "Strong knowledge of HVAC, electrical, plumbing, and fire fighting systems, specifically their installation constraints within Miven structures.",
        "Proficiency in AutoCAD is essential. Knowledge of Revit MEP is a plus.",
        "Experience in site supervision and coordination with civil/Miven teams.",
        "Familiarity with relevant Indian MEP codes and standards.",
        "Good communication and problem-solving skills.",
      ],
    ...
    },
    {
      ...
      requirements: [
        ...
        "Mandatory proven experience in high-rise building projects using Miven technology.",
        "Strong leadership, planning, and communication skills.",
        "Expert knowledge of construction methods, quality control procedures, and safety regulations specific to high-rise Miven projects.",
        "Experience in coordinating with various stakeholders, including architects, engineers, and subcontractors.",
        "Familiarity with relevant Indian building codes and standards.",
        "Excellent problem-solving and decision-making abilities.",
      ],
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "We are looking for a highly skilled Planning Engineer with mandatory experience in high-rise building projects using Miven technology. The candidate will be responsible for developing, updating, and monitoring detailed project schedules, ensuring the execution strategy aligns with the Miven cycle for efficient project delivery.",
      requirements: [
        "Bachelor's degree in Civil Engineering or a related field is mandatory.",
        "Minimum 10 years of experience as a Planning Engineer.",
        "Mandatory proven experience in planning and scheduling for high-rise building projects with Miven technology.",
        "Proficiency in project management software such as Primavera P6 or Microsoft Project is essential.",
        "Strong analytical skills to analyze progress, manage resource allocation, and specifically optimize the Miven construction cycle.",
        "Experience in risk analysis, mitigation planning, and earned value management.",
        "Excellent communication and coordination skills.",
        "Familiarity with relevant Indian building codes and standards.",
      ],
      postedDate: "2025-11-25",
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking a dedicated Quality RMC (Ready-Mix Concrete) Engineer responsible for ensuring the quality of concrete production, testing, and delivery at our plant and construction sites. The role involves managing quality control processes and ensuring compliance with all material and structural specifications.",
      requirements: [
        "Bachelor's degree in Civil Engineering is mandatory.",
        "Minimum 4 to 5 years of experience as a Quality Engineer with a focus on RMC.",
        "Mandatory proven experience in RMC plant operations, concrete mix design, and quality testing procedures.",
        "Strong knowledge of aggregates, admixtures, and concrete properties.",
        "Expertise in conducting slump tests, cube tests, and analysis of test results as per Indian standards.",
        "Familiarity with relevant Indian codes (e.g., IS 456, IS 10262) for concrete mix design and testing.",
        "Good communication and documentation skills for preparing quality reports and ensuring site adherence.",
      ],
      postedDate: "2025-11-25",
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking a dedicated Safety Engineer to implement and enforce all health, safety, and environmental protocols at our residential project site. The role involves conducting risk assessments, safety audits, and training to ensure compliance with all statutory and company safety standards.",
      requirements: [
        "Bachelor's degree in Civil/Mechanical Engineering with a Post Graduate Diploma in Industrial Safety or relevant certification (e.g., NEBOSH) is mandatory.",
        "Minimum 5 years of experience in site safety management for construction projects.",
        "Mandatory proven experience in managing HSE for **residential construction projects**.",
        "Strong knowledge of construction safety hazards, risk assessment techniques, and mitigation strategies.",
        "Experience in conducting safety training, toolbox talks, and incident investigation.",
        "Familiarity with relevant Indian safety codes and labor laws.",
        "Excellent communication and leadership skills to promote a strong safety culture.",
      ],
      postedDate: "2025-11-25",
    },
    ...
    },
    {
      ...
      vacancy: 1,
      description:
        "We are seeking a highly experienced QS and Contracts Manager to oversee all commercial and contractual aspects of our residential projects. The role covers quantity surveying, tender management, contract drafting, and administration, ensuring cost control and contractual compliance.",
      requirements: [
        "Bachelor's degree in Civil Engineering or Quantity Surveying is mandatory.",
        "Minimum 10 years of experience in Quantity Surveying and Contracts Management.",
        "Mandatory proven experience in managing and executing **residential construction projects** (villas or apartments).",
        "Expert knowledge of tender documentation, contract drafting, B.O.Q. preparation, and cost estimation.",
        "Strong understanding of contract laws, administration, claims management, and vendor negotiation.",
        "Proficiency in relevant QS software and advanced MS Excel.",
        "Excellent communication, negotiation, and analytical skills.",
      ],
      postedDate: "2025-11-25",
    },
    {
      ...
      requirements: [
        "Bachelor's degree in Civil Engineering or Quantity Surveying is mandatory.",
        "Minimum 5 years of experience in Quantity Surveying and Billing.",
        "Mandatory proven experience in **residential construction projects** (villas or apartments).",
        "Strong knowledge of taking off quantities, preparing Bills of Quantities (BOQ), and cost estimation.",
        "Expertise in preparing and checking interim and final bills for subcontractors and vendors based on site measurements.",
        "Experience in rate analysis, budget monitoring, and reconciliation of material consumption.",
        "Familiarity with relevant Indian measurement and contract codes.",
        "Excellent analytical, negotiation, and documentation skills.",
      ],
