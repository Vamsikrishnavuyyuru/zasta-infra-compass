...
const JobListings = ({ onApply }: JobListingsProps) => {
  ...
  const currentOpenings: JobOpening[] = [
      ...
      experience: "4+ years",
      vacancy: 5, 
      description: "We are hiring MEP Engineers for our villa project. You will manage Mechanical, Electrical, and Plumbing systems. This includes design, installation, and supervision. Ensure all MEP systems are installed correctly and efficiently.",
      requirements: [
      ...
      experience: "4+ years",
      vacancy: 1, 
      description: "We are hiring MEP Finishing Engineers for our villa project. You will focus on the final stages of MEP installation. Ensure aesthetic integration and functionality of all MEP components. Coordinate closely with finishing teams.",
      requirements: [
        "Bachelor's degree in Electrical or Mechanical Engineering is required",
      ...
      experience: "10+ years",
      vacancy: 5,
      description: "We are looking for a Civil QA/QC Engineer for our high-rise luxury project in Mumbai. You must have 10+ years of experience in structural quality. Work on a prestigious luxury development. Ensure the highest quality standards throughout construction.",
      requirements: [
        "Bachelor's degree in Civil Engineering.",
    ...
    },
    {
      ...
      experience: "5-8 years",
      vacancy: 3,
      description: "We are seeking Civil Engineers for structural work on our Mumbai high-rise project. You will focus on structural design and supervision. Work on a luxury development in Mumbai. Ensure structural integrity and timely completion.",
      requirements: [
        "Bachelor's degree in Civil Engineering.",
    ...
    },
    {
      ...
      experience: "4+ years",
      vacancy: 2,
      description: "We are looking for Quality Engineers to ensure high standards on our Mumbai project. You will monitor construction quality and implement QA/QC procedures. Focus on maintaining luxury project standards throughout construction.",
      requirements: [
        "Bachelor's degree in Civil Engineering.",
