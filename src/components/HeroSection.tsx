...
const HeroSection = () => {
  ...
  const slides: Slide[] = [
    ...
    },
    {
      ...
      subtitle:
        "Delivering specialized engineering solutions across real estate, power, transportation, and industrial sectors",
      cta: "Our Expertise",
    ...
    <section className="relative min-h-screen pt-16 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white min-h-screen pt-8 pb-24 flex flex-col justify-center">
        <div className="flex-1 flex items-center justify-center">
          <HeroContent slides={slides} currentSlide={currentSlide} onWorkWithUs={handleWorkWithUs} />
        </div>
        <div className="mt-8">
          <HeroStats />
        </div>
      ...
      <SlideIndicators totalSlides={slides.length} currentSlide={currentSlide} onSlideChange={setCurrentSlide} />
    </section>
  );
};
